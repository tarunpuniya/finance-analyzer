...
for _ in range(data_size):
    ...
    if savings_rate >= 0.30:
        limit_factor = np.random.uniform(0.65, 0.72) 
    elif savings_rate >= 0.20:
        limit_factor = np.random.uniform(0.60, 0.68)  
    elif savings_rate >= 0.10:
        limit_factor = np.random.uniform(0.55, 0.63)  
    else:
        limit_factor = np.random.uniform(0.50, 0.58) 
